  ...
  return (
    ...
    >
      ...
      <div className="container relative z-20 px-6 md:px-10 mx-auto text-center text-white">
        ...
        <h1 className="text-4xl md:text-5xl lg:text-heading-xl max-w-4xl mx-auto font-bold leading-tight mb-6 opacity-0 animate-slide-down" style={{ animationDelay: "0.2s", animationFillMode: "forwards" }}>
          We Create Unforgettable <span className="text-gradient">Moments</span> For Your Special Day
        </h1>
        
        <p className="text-body-lg max-w-2xl mx-auto text-white/90 mb-10 opacity-0 animate-fade-in" style={{ animationDelay: "0.4s", animationFillMode: "forwards" }}>
          Specializing in weddings, religious ceremonies, birthdays, and more. We bring your vision to life with elegance and precision at the most economical rates.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-fade-in" style={{ animationDelay: "0.6s", animationFillMode: "forwards" }}>
         <Link to='/events'>
          <Button size="lg" className="bg-primary hover:bg-primary/90 text-white px-8 button-glow">
            Explore events
          </Button>
          </Link>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Discover the variety of events we specialize in, from religious ceremonies to social gatherings
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 animate-fade-in">
                ...
                <p className="text-muted-foreground mb-8">
                  At WeManageYourEvents, we believe that every special moment deserves exceptional 
                  attention to detail. Our dedicated team brings creativity, precision, and passion 
                  to every event we organize.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        Our team has organized hundreds of successful events across various categories
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h3 className="text-base font-medium">Personalized Service</h3>
                      <p className="mt-1 text-sm text-muted-foreground">
                        We create custom experiences tailored to your unique vision and requirements
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h3 className="text-base font-medium">Attention to Detail</h3>
                      <p className="mt-1 text-sm text-muted-foreground">
                        We obsess over the small details that make an event truly remarkable
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-20 px-6 md:px-8 bg-white">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
              Let's work together to bring your vision to life. Contact us today to begin planning 
